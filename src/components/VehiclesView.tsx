...
import { 
  ...
  ChevronRight, ChevronLeft, CheckCircle, Info, Upload, Save
} from "lucide-react";
...
export default function VehiclesView({
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      ...
      {/* ========================================================== */}
      {/* MODAL ULTRA PREMIUM : NOUVEAU VÉHICULE AVEC ÉTAPES */}
      {/* ========================================================== */}
      {isModalOpen && (
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                          ...
                          <input
                            type="text"
                            required
                            placeholder="LT-452-XY"
                            value={formImmatriculation}
                            onChange={(e) => setFormImmatriculation(e.target.value.toUpperCase())}
                            className="mt-1.5 w-full border-2 border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 focus:outline-none transition-all font-mono uppercase"
                          />
                        </div>
                        <div>
                          <label className="text-sm font-semibold text-slate-700 flex items-center space-x-1">
                        ...
                        <div>
                          ...
                          <div className="flex items-center space-x-2 mt-1.5">
                            ...
                            <input
                              ...
                              value={formCouleur}
                              onChange={(e) => setFormCouleur(e.target.value)}
                              className="flex-1 border-2 border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 focus:outline-none transition-all"
                            />
                          </div>
                        </div>
                        <div>
                          <label className="text-sm font-semibold text-slate-700">État général</label>
                          <select
                            value={formEtat}
                        ...
                        <div>
                          <label className="text-sm font-semibold text-slate-700 flex items-center space-x-1">
                            <span>Versement journalier (FCFA)</span>
                            <span className="text-rose-500">*</span>
                          </label>
                          <input
                            type="number"
                            ...
                            className="mt-1.5 w-full border-2 border-slate-200 rounded-xl px-4 py-2.5 text-sm font-semibold text-emerald-600 focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 focus:outline-none transition-all"
                          />
                        </div>
                        <div>
                          <label className="text-sm font-semibold text-slate-700">Date d'acquisition</label>
                          <input
                            type="date"
                        ...
                        <div>
                          <label className="text-sm font-semibold text-slate-700">Numéro châssis</label>
                          <input
                            type="text"
                            placeholder="VF1..."
                            value={formChassis}
                            onChange={(e) => setFormChassis(e.target.value.toUpperCase())}
                            className="mt-1.5 w-full border-2 border-slate-200 rounded-xl px-4 py-2.5 text-sm font-mono focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 focus:outline-none transition-all"
                          />
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div className="bg-white p-4 rounded-xl border-2 border-emerald-200 shadow-sm">
                          <div className="flex items-center space-x-2 mb-3">
                            ...
                            <label className="font-bold text-emerald-700">Carte Grise</label>
                          ...
                          <div className="space-y-3">
                            <input
                              ...
                              className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 focus:outline-none transition-all"
                            />
                            <input
                              type="date"
                              required
                        ...
                        <div className="bg-white p-4 rounded-xl border-2 border-emerald-200 shadow-sm">
                          <div className="flex items-center space-x-2 mb-3">
                            ...
                            <label className="font-bold text-emerald-700">Assurance</label>
                            <span className="text-rose-500 text-xs">*</span>
                          </div>
                          <div className="space-y-3">
                            <input
                        ...
                        <div className="bg-white p-4 rounded-xl border-2 border-emerald-200 shadow-sm">
                          <div className="flex items-center space-x-2 mb-3">
                            ...
                            <label className="font-bold text-emerald-700">Visite Technique</label>
                            <span className="text-rose-500 text-xs">*</span>
                          </div>
                          <div className="space-y-3">
                            <input
                        ...
                        <div className="bg-white p-4 rounded-xl border-2 border-emerald-200 shadow-sm">
                          <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center space-x-2">
                              ...
                              <label className="font-bold text-emerald-700">Licence Transport</label>
                            </div>
                            <label className="flex items-center space-x-2 cursor-pointer">
                              ...
                              />
                              <span className="text-xs text-slate-600">Activer</span>
                            </label>
                          </div>
                          {hasLicence && (
                            <div className="space-y-3">
                          ...
                          {!hasLicence && (
                            <p className="text-sm text-slate-400 italic mt-2">Non requis pour ce véhicule</p>
                          )}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-6 rounded-2xl">
                      ...
                      <div className="bg-white rounded-xl p-5 space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm">
                          <div className="text-slate-500">Immatriculation:</div>
                          <div className="font-semibold text-slate-800 font-mono">{formImmatriculation || "—"}</div>
                          
                          <div className="text-slate-500">Marque / Modèle:</div>
                          <div className="font-semibold text-slate-800">{formMarque} {formModele}</div>
                          
                          <div className="text-slate-500">Année / Couleur:</div>
                          <div className="font-semibold text-slate-800">{formAnnee || "—"} / {formCouleur || "—"}</div>
                          
                          <div className="text-slate-500">État:</div>
                          <div className="font-semibold text-slate-800">{getEtatLabel(formEtat)}</div>
                          
                          <div className="text-slate-500">Versement journalier:</div>
                          <div className="font-bold text-emerald-600">{formatFCFA(formMontantJournalier)}</div>
                          
                          <div className="text-slate-500">Documents:</div>
                          <div className="text-emerald-600">
                            {formDocCarteNumero && formDocAssuranceNumero && formDocVisiteNumero ? (
                              <span className="flex items-center space-x-1"><Check className="h-3 w-3" /> Complets</span>
                            ) : "Incomplets"}
                          </div>
                        </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    {currentStep < totalSteps ? (
                      ...
                      >
                        ...
                        <span>{editingVehicle ? "Mettre à jour" : "Enregistrer"}</span>
                      </button>
                    )}
                  </div>
                </div>
            ...
            <div className="px-6 py-4 border-b border-slate-100 bg-gradient-to-r from-slate-50 to-white rounded-t-2xl">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h2 className="text-lg font-bold text-slate-800">Affecter un chauffeur</h2>
                    <p className="text-xs text-slate-500">{selectedVehForAssign.immatriculation}</p>
                  </div>
                </div>
                <button onClick={() => setIsAssignModalOpen(false)} className="p-1 rounded-lg hover:bg-slate-100">
            ...
            <form onSubmit={handleAssignSubmit} className="p-6 space-y-5">
              <div>
                ...
                <div className="bg-slate-50 p-3 rounded-lg border border-slate-200">
                  <p className="text-sm font-semibold text-slate-800">{selectedVehForAssign.marque} {selectedVehForAssign.modele}</p>
                  <p className="text-xs text-slate-500 font-mono">{selectedVehForAssign.immatriculation}</p>
                </div>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full border border-slate-200 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 focus:outline-none transition-all"
                >
                  <option value="">-- Sélectionner un chauffeur --</option>
                  {chauffeurs.map((c) => (
                    <option key={c.id} value={c.id}>
                      {c.prenom} {c.nom} - {c.telephone} {c.vehiculeId ? '(Occupé)' : '(Disponible)'}
                    </option>
                  ))}
                </select>
              </div>
              ...
              <div>
                <label className="text-xs font-semibold text-slate-700 block mb-1">Notes et consignes</label>
                <textarea
                  placeholder="Ex: Prise de service quotidienne à 7h, vérification des niveaux..."
                  value={assignRemark}
                  onChange={(e) => setAssignRemark(e.target.value)}
                  rows={3}
                  className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 focus:outline-none transition-all resize-none"
                />
              </div>
              ...
              <div className="flex items-center justify-end space-x-3 pt-4 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 rounded-lg text-sm font-bold bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-slate-950 shadow-md hover:shadow-lg transition-all"
                >
