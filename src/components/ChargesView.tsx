...
import { 
  ...
  Search, ChevronLeft, ChevronRight, Save, Info, TrendingUp, Receipt, Car, UserCheck
} from "lucide-react";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        <div className="group bg-white rounded-2xl border border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
          <div className="p-5">
            ...
            <div>
              <p className="text-xs text-slate-500 font-medium uppercase tracking-wide">Dépenses Validées</p>
              <h3 className="text-2xl font-bold text-emerald-600 mt-1">{formatFCFA(totalValidatedCosts)}</h3>
            </div>
          </div>
        ...
        <div className="group bg-white rounded-2xl border border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
          <div className="p-5">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-amber-600 mt-1">{formatFCFA(totalPendingCosts)}</h3>
            </div>
          </div>
                    ...
                    <tr key={e.id} className="hover:bg-slate-50/50 transition-colors duration-150">
                      <td className="px-5 py-3">
                        <div>
                          ...
                          <p className="text-[10px] font-mono text-slate-400">{e.id.slice(-8)}</p>
                        </div>
                       </td>
                      <td className="px-5 py-3">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 font-mono">ID: {selectedExpenseForDetail.id.slice(-8)}</p>
                    </div>
                  </div>
