...
import { 
  ...
  TrendingUp, Award, Smartphone, Building
} from "lucide-react";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        ...
        <div className="group bg-white rounded-2xl border border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
          <div className="p-5">
            ...
            <div>
              <p className="text-xs text-slate-500 font-medium uppercase tracking-wide">Total Encaissé & Validé</p>
              <h3 className="text-2xl font-bold text-emerald-600 mt-1">{formatFCFA(totalCollectedAmount)}</h3>
            </div>
          </div>
        ...
        <div className="group bg-white rounded-2xl border border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
          <div className="p-5">
            <div className="flex items-center justify-between mb-3">
              ...
              <RefreshCw className="h-4 w-4 text-amber-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </div>
            <div>
              <p className="text-xs text-slate-500 font-medium uppercase tracking-wide">En Attente de Validation</p>
              <h3 className="text-2xl font-bold text-amber-600 mt-1">{formatFCFA(totalPendingAmount)}</h3>
            </div>
          </div>
        ...
        <div className="group bg-white rounded-2xl border border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
          <div className="p-5">
            <div className="flex items-center justify-between mb-3">
              ...
              <AlertTriangle className="h-4 w-4 text-rose-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </div>
            <div>
              <p className="text-xs text-slate-500 font-medium uppercase tracking-wide">Arriérés Cumulés</p>
              <h3 className="text-2xl font-bold text-rose-600 mt-1">{formatFCFA(totalLateOutstanding)}</h3>
            </div>
          </div>
          ...
          <table className="w-full">
            <thead className="bg-slate-50 border-b border-slate-200">
              <tr className="text-[11px] font-mono text-slate-500 uppercase">
                <th className="px-5 py-3 text-left">Date / ID</th>
                  ...
                  <tr key={p.id} className="hover:bg-slate-50/50 transition-colors duration-150">
                    <td className="px-5 py-3">
                      <div>
                        ...
                        <p className="text-[10px] font-mono text-slate-400">{p.id.slice(-8)}</p>
                      </div>
                    </td>
                    <td className="px-5 py-3">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 font-mono">ID: {selectedPaymentForDetail.id.slice(-8)}</p>
                    </div>
                  </div>
