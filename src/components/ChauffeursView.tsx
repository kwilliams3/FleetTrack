...
import { 
  ...
  Calendar, IdCard, UserCheck, Clock, AlertTriangle, Save, Check, Info, Users
} from "lucide-react";
...
export default function ChauffeursView({
  ...
  const nextStep = () => {
    if (currentStep < totalSteps) {
      if (currentStep === 1 && (!formNom || !formPrenom || !formTelephone)) {
        alert("Veuillez remplir les informations d'identité");
        return;
      }
      if (currentStep === 2 && (!formNumPermis || !formExpPermis)) {
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="group bg-white rounded-2xl border border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
          <div className="p-4">
            ...
            <p className="text-xs text-slate-500 font-medium">Total chauffeurs</p>
            <h3 className="text-2xl font-bold text-slate-800">{chauffeurs.length}</h3>
          </div>
        ...
        <div className="group bg-white rounded-2xl border border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
          <div className="p-4">
            ...
            <h3 className="text-2xl font-bold text-emerald-600">{chauffeurs.filter(c => c.isActive).length}</h3>
          </div>
        ...
        <div className="group bg-white rounded-2xl border border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
          <div className="p-4">
            ...
            <p className="text-xs text-slate-500 font-medium">Permis expirés</p>
            <h3 className="text-2xl font-bold text-rose-600">{chauffeurs.filter(c => checkPermisExpired(c.expPermis).status === "expired").length}</h3>
          </div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="relative">
                    {c.photo ? (
                      ...
                      <div className="h-16 w-16 rounded-full bg-gradient-to-br from-amber-400 to-amber-500 flex items-center justify-center shadow-md">
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-slide-down relative">
            ...
            <form onSubmit={handleFormSubmit}>
              <div className="p-6">
                  ...
                  <div className="space-y-6 animate-fade-in-up">
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-5 rounded-2xl">
                      <div className="flex items-center space-x-2 mb-4">
                        ...
                        <h3 className="text-sm font-bold text-slate-700">Identité du chauffeur</h3>
                      </div>
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="col-span-2">
                          <label className="text-xs font-semibold text-slate-700 block mb-1">Photo de profil</label>
                          <div className="flex items-center space-x-4">
                            {formPhoto ? (
                              <div className="relative">
                ...
                {currentStep === 2 && (
                  <div className="space-y-6 animate-fade-in-up">
                    <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-5 rounded-2xl">
                      <div className="flex items-center space-x-2 mb-4">
                        <Award className="h-4 w-4 text-amber-600" />
                        <h3 className="text-sm font-bold text-slate-700">Permis de conduire</h3>
                      </div>
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <label className="text-xs font-semibold text-slate-700 block mb-1">Numéro de permis *</label>
                          <input
                            type="text"
                            required
                            ...
                            className="w-full border-2 border-slate-200 rounded-xl px-4 py-2.5 text-sm font-mono focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 focus:outline-none transition-all uppercase"
                          />
                        </div>
                        <div>
                          <label className="text-xs font-semibold text-slate-700 block mb-1">Date d'expiration *</label>
                          <input
                            type="date"
                            required
                            value={formExpPermis}
                    ...
                    <div className="bg-gradient-to-r from-emerald-50 to-teal-50 p-5 rounded-2xl">
                      <div className="flex items-center space-x-2 mb-4">
                        ...
                        <h3 className="text-sm font-bold text-slate-700">Affectation véhicule</h3>
                      </div>
                  ...
                  <div className="space-y-6 animate-fade-in-up">
                    <div className="bg-gradient-to-r from-indigo-50 to-purple-50 p-5 rounded-2xl">
                      <div className="flex items-center space-x-2 mb-4">
                        ...
                        <h3 className="text-sm font-bold text-slate-700">Vérification finale</h3>
                      </div>
      ...
      {/* ========================================================== */}
      {/* MODAL: DETAILS CHAUFFEUR - VERSION PREMIUM SANS ID */}
      {/* ========================================================== */}
            ...
            <div className="relative">
              ...
              <div className="px-6 py-4 border-b border-slate-100 bg-gradient-to-r from-slate-50 to-white">
                <div className="flex items-center justify-between">
                  ...
                  <button onClick={() => setSelectedChauffeurForDetail(null)} className="p-2 rounded-lg hover:bg-slate-100 transition-colors">
